...
//java     sps 长度 sps内容 pps  长度  pps 内容
...
Java_com_maniu_openglrecord_MediaEncoderAndPush_connect(JNIEnv *env, jobject thiz, jstring url_) {
    int ret;
...
//00 00 00 01 67     64001EACB40F028D2905060606D0A135    00000001  68EE06F2C0

//00 00 00 01 65 B8 40 A7 FA5D5ECD2DAC49914EE6E2B58E35BF0B2B92B5B80F107CC548B01336D793C2E3ECAD
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_maniu_openglrecord_MediaEncoderAndPush_sendData(JNIEnv *env, jobject thiz, jbyteArray data_,
                                                         jint len, jlong tms) {
    int ret;
