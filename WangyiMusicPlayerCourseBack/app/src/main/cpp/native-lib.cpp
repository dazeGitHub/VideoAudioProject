...
extern "C"
JNIEXPORT void JNICALL
Java_com_maniu_wangyimusicplayer_service_MNPlayer_n_1speed(JNIEnv *env, jobject thiz,
                                                           jfloat speed) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_maniu_wangyimusicplayer_service_MNPlayer_n_1higth(JNIEnv *env, jobject thiz,
                                                           jfloat speed) {
    if (ffmpeg != NULL) {
        ffmpeg->setHigth(speed);
    }
}