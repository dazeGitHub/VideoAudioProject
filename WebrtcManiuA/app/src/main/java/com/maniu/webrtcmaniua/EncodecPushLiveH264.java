...
//核心
    ...
    public void startLive() {
        try {
            ...
            //这里 height 和 width 反着写, 是为了防止出现多条杠的图像
            ...
            //google 自己也不太支持 nv21, 只有 COLOR_FormatYUV420Flexible 即 nv12, 而没有 nv21
...
//    一帧数据 过来
//  LocalSurfaceView 的 onPreviewFrame() 方法调用该 encodeFrame() 方法
